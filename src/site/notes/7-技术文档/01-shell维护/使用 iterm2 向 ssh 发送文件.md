---
{"dg-publish":true,"permalink":"/7-技术文档/01-shell维护/使用 iterm2 向 ssh 发送文件/","tags":["mac","iterm2"]}
---


mac: `brew install lrzsz`
server: `apt-get install lrzsz`


mac中创建文件：`/usr/local/bin/iterm2-zmodem`

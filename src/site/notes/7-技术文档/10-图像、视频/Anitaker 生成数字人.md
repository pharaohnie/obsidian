---
{"dg-publish":true,"permalink":"/7-技术文档/10-图像、视频/Anitaker 生成数字人/","tags":["AI","数字人"]}
---
...
效果没有 [[7-技术文档/10-图像、视频/Hallo-webui 生成数字人\|Hallo]] 好
...
找一个 wav 文件，或者用 [[7-技术文档/15-音频/CosyVoice 训练\|CosyVoice]] 生成语音文件，改名为 `audio.wav`

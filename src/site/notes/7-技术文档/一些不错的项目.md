...
| 18  | crawl4ai            | AI网站爬虫                                      | [GitHub - unclecode/crawl4ai: 🔥🕷️ Crawl4AI: Open-source LLM Friendly Web Crawler & Scrapper](https://github.com/unclecode/crawl4ai)                                                            |
| 19  | eraser              | 流程图网站，做的很专业                                 | [Eraser](https://app.eraser.io/)                                                                                                                                                                 |
| 20  | zerox               | 利用gpt进行ocr                                  | [GitHub - getomni-ai/zerox: Zero shot pdf OCR with gpt-4o-mini](https://github.com/getomni-ai/zerox)                                                                                             |
| 21  | docling             | 有一个pdf的ocr解决方案                              | [GitHub - DS4SD/docling: Get your documents ready for gen AI](https://github.com/DS4SD/docling)                                                                                                  |
| 22  | letta               | 带有记忆的gpt                                    | [GitHub - letta-ai/letta: Letta (formerly MemGPT) is a framework for creating LLM services with memory.](https://github.com/letta-ai/letta)                                                      |
| 23  | graphrag-visualizer | 使用graphrag的前端展示界面，项目里需要使用开发者编写的graphrag-api | [GitHub - noworneverev/graphrag-visualizer: A web-based tool for visualizing and exploring artifacts from Microsoft's GraphRAG.](https://github.com/noworneverev/graphrag-visualizer)            |
...
| 11  | facepoke       | 拖动鼠标调整人物脸的角度                    | [GitHub - jbilcke-hf/FacePoke: Select a portrait, click to move the head around (please use your own space / GPU!)](https://github.com/jbilcke-hf/FacePoke)                    |
| 12  | MagicQuill     | AI 修改图                          | [GitHub - magic-quill/MagicQuill: Official Implementations for Paper - MagicQuill: An Intelligent Interactive Image Editing System](https://github.com/magic-quill/magicquill) |
|     |                |                                 |                                                                                                                                                                                |
...
| 4   | fish speech                            | 另一个不错的语音模拟 ai                        | [GitHub - fishaudio/fish-speech: Brand new TTS solution](https://github.com/fishaudio/fish-speech)                                                                                                                                                             |
| 5   | seed-vc                                | 一个受 SEED-TTS 启发的新型零样本声音转换方案。         | [GitHub - Plachtaa/seed-vc: zero-shot voice conversion with in context learning](https://github.com/Plachtaa/seed-vc)                                                                                                                                          |
| 6   | PDF2Audio                              | 使用pdf生成播客的程序                         | [GitHub - lamm-mit/PDF2Audio](https://github.com/lamm-mit/PDF2Audio)                                                                                                                                                                                           |
| 7   | notebookllm-chinese                    | 利用deepseek和声睿生成中文播客                  | [GitHub - dubeno/NotebookLLM-Chinese: Cross Platform Open Sourced Chinese NoteBookLM  app based on Electron, Use DeepSeek + Reecho.ai](https://github.com/dubeno/NotebookLLM-Chinese)                                                                          |
| 8   | Ten Agent                              | 语音交互框架                               | [GitHub - TEN-framework/TEN-Agent: TEN Agent is the world’s first real-time multimodal agent integrated with the OpenAI Realtime API, RTC, and features weather checks, web search, vision, and RAG capabilities.](https://github.com/TEN-framework/TEN-Agent) |
| 9   | MaskGCT                                | 最新的声音克隆，效果非常不错                       | [Amphion/models/tts/maskgct at main · open-mmlab/Amphion · GitHub](https://github.com/open-mmlab/Amphion/tree/main/models/tts/maskgct)                                                                                                                         |
| 10  | clear-voice                            | 多人同时对话，分离声音，支持视频                     | [ClearerVoice-Studio/clearvoice at main · modelscope/ClearerVoice-Studio · GitHub](https://github.com/modelscope/ClearerVoice-Studio/tree/main/clearvoice)                                                                                                                                                     |
...
| 13  | Hedra            | 目前看到最好的商业数字人，也不太贵。上传一张图片就可以。API需要申请。25美金，每个月1小时视频                                | [Hedra](https://www.hedra.com/)                                                |
| 14  | Heygen           | 上传视频或用摄像头录像就可以做数字人了，会自动克隆声音。24美金，无限时长，1080p导出。有企业版的API。                          | [HeyGen - AI Spokesperson Video Creator](https://app.heygen.com/)              |
| 15  |                  |                                                                                  |                                                                                |

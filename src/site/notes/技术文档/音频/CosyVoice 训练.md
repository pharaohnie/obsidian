---
{"dg-publish":true,"permalink":"/技术文档/音频/CosyVoice 训练/","tags":["AI","语音"]}
---
...
1. 准备语音集（参考 [[技术文档/音频/GPT-SoVITS 训练\|GPT-SoVITS 训练]] 中的 2-7 步）
2. 安装 CosyVoice
3. 准备目录和数据
4. 准备训练脚本
5. 开始训练
...
修改 `INPUT_FILE` ，确保使用 [[技术文档/音频/GPT-SoVITS 训练\|GPT-SoVITS 训练]] 中的 2-7 步准备好语音集后，运行 asr.sh
